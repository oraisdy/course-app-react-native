  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Animated.Image source={require("../../2.png")} style={[animatedStyle2,{height:width}]} resizeMode='cover' />
        <Animated.View style={[styles.box, animatedStyle]}>
          <Image source={require("../../1.png")} resizeMode='cover' style={{width:width*2,height:width*2}} />
        </Animated.View>
